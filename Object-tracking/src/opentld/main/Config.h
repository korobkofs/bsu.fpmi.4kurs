...
/**
 * @brief Config is used to configure the program by cli and/or by a config file
 */
class Config
{
public:
    /**
     * @brief This constructor configures by default.
     */
    Config();

    /**
     * @brief This constructor configures on settings
     *
     * @param settings
     *          the settings
     */
    ...
    /**
     * @brief Configures the CamNode, ImAcq and TldClassifier.
     *
     * @param main
     *          the main object
     * @return SUCCESS
