...
/**
 * @brief Detection trajectory; a line which associates the last detections.
...
public:
	/**
     * @brief Constructor; don't forget to call init(length) afterwards
	 */
	Trajectory();
	...
	/**
     * @brief Adds a new point to the trajectory.
	...
	/**
     * @brief Draws the trajectory into an image.
