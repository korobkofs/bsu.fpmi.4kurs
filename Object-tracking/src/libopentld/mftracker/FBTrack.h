...
/**
 * @brief Calculate the bounding box of an Object in a following Image.
 * Imgs aren't changed.
 ...
 *                   Format x1,y1,x2,y2
 * @param bbnew      Output, contains predicted BoundingBox.
 * @param scaleshift returns relative scale change of bb
 * @return 0, if shift of an Object far (medFb > 10); 1, otherwise
 */
